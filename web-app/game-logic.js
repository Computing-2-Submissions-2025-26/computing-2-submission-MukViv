 ...
 * `place_police_car`. The returned state includes an updated `board` and
 * `winner` field, so UI code can render directly from it after every accepted
 * action.
...
/**
 * Board marker for a square with nothing on it.
 * @memberof ChessThieves
 * @constant {string}
 */
const EMPTY = "empty";
...
/**
 * Board marker for the Thief's square.
 * @memberof ChessThieves
 * @constant {string}
 */
const THIEF = "thief";
...
/**
 * Board marker for the King's square.
 * @memberof ChessThieves
 * @constant {string}
 */
const KING = "king";
...
/**
 * Board marker for the Exit square.
 * @memberof ChessThieves
 * @constant {string}
 */
const EXIT = "exit";
...
/**
 * Board marker for a permanent traffic barrier placed at setup.
 * @memberof ChessThieves
 * @constant {string}
 */
...
/**
 * Board marker for a police car placed by the King.
 * @memberof ChessThieves
 * @constant {string}
 */
 ...
 * `place_police_car`. A valid placement must be on the board, empty, within
 * `MAX_POLICE_CARS`, and must leave at least one open path from the Thief to
 * the Exit after the police car is added.
 *
 * @param {ChessThieves.GameState} game The current game state.
 ...
 *
 * @param {ChessThieves.GameState} game The current game state.
 * @param {ChessThieves.Position} position The square where the police car
 * should be placed.
 * @returns {ChessThieves.GameState|null} The updated game state, or null if
